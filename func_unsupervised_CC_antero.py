...
"""
Published on Sat Mar 2 17:29:47 2024

@author: Eric Li, Hannah Choi
"""
"""
This code contains functions needed for mapping anterograde CC clusters to FF/FB by 
maximizing the global hierarchy score of the given cortico-cortical connectivity data, 
and is called in "run_CC_shuffled.py" and "run_CC_module.py".
"""
...
def fit_antero(df, parallel=True, n_procs=-1):
