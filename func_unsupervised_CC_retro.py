...
"""
Published on Sat Mar 2 17:38:32 2024

@author: Eric Li, Hannah Choi
"""
"""
This code contains functions needed for mapping retrograde CC clusters to FF/FB by 
maximizing the global hierarchy score of the given cortico-cortical connectivity data, 
and is called in "run_CC.py", "run_CC_shuffled.py", and "run_CC_module.py".
"""
...
def fit_retro(df, parallel=True, n_procs=-1):
